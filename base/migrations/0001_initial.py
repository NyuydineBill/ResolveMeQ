# Generated by Django 5.2.2 on 2025-06-24 23:41
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Auto-generated secure code for user verification",
                        max_length=6,
                        null=True,
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True,
                        help_text="The date and time when the secure code expires",
                        null=True,
                        verbose_name="secure code expiry",
                    ),
                ),
                (
                    "is_active",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ImageField(
                        blank=True,
                        help_text="Upload a profile image (JPG, PNG, WebP). Max size: 5MB.",
                        null=True,
                        upload_to=base.models.profile_image_path,
                        validators=[
                            django.core.validators.FileExtensionValidator(
                                allowed_extensions=["jpg", "jpeg", "png", "webp"]
                            ),
                            base.models.validate_image_size,
                        ],
        ...
        migrations.AddIndex(
            model_name="user",
            index=models.Index(
                fields=["secure_code"], name="base_user_secure__416ced_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="user",
            index=models.Index(
                fields=["is_active", "is_staff"], name="base_user_is_acti_cbbc04_idx"
            ),
        ),
    ]
